...
# some initialize function mess onlyProxy or onlyOwner

## Summary

there is some initialize functions are messing modifier ! 
## Vulnerability Detail
the initialize function at some contract files is mess onlyOwner modifier allow any one call this function become the owner of that contract 
## Impact
